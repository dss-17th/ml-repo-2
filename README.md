...
### 2.4 CNN 모델 적용 
- 랜덤 샘플링을 통해 이미지 개수를 대폭 감소하였기 때문에, Transfer Learning을 사용하였습니다.
...
- 학습 데이터의 양이 충분하지 못할 때 Transfer Learning이 필요하며, Transfer Learning은 Inception 계열의 모델에서 좋은 성능을 보인다는 것을 알게 되었습니다.
